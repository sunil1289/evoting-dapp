...
const VoterDashboard = () => {
  ...
  <div className="row m-3">
    ...
    <div className="vote-div">
      <div className="card card-vote w-100">
        <div className="card-body text-center p-3">
          <h1 className="text-white mb-2">VOTE NOW</h1>
        </div>
        <Link className="card-footer text-white text-center" to="/voter/vote">
          <span>Goto vote ❯</span>
        </Link>
      </div>
    </div>
          ...
          <div className="row m-3 row-features">
            ...
            <div className="col-12 col-lg-3 col-md-12 col-sm-12 my-3">
              <div className="card card-chat w-100 h-100">
                ...
                <Link className="card-footer text-white" to="/voter/manifestos">
