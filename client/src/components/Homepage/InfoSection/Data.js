export const homeObjOne = {
  ...
  description:
    'Redefining voting with secure technology and open access to results.',
...
export const homeObjTwo = {
  ...
  description:
    'With Decenterlized E-Voting you will now be able to vote without the hassle of standing in long queues and we also assure with full confidence that your vote will never be tampered.',
  buttonLabel: 'Get started',
  imgStart: true,
